...
class TransactionRecordUseCase extends ApiHelper {
  TransactionRecordUseCase(ConnectionController connectionManager,
  ...
  Future<ResponseHandler?> getTransactionRecord()async {
    try {
      final result = await getMethod(ApiClient.paymentTransactionRecord);
