...
class BrowserCargoUseCase extends ApiHelper {
  BrowserCargoUseCase(ConnectionController connectionManager,
  ...
  Future<ResponseHandler?> getItemDetails(String? itemId)async {
    try {
      final result = await getMethod("${ApiClient.statusLog}/$itemId");
